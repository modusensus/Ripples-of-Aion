...
> **临时备注（2026-09）**：Cyrene 上游维护者的 GitHub 账号暂时被封禁（申诉中），上游仓库 [`Playa-0v0/Cyrene-Plugins`](https://github.com/Playa-0v0/Cyrene-Plugins) 暂无法访问；插件收录与分发暂由 [Gitee 镜像](https://gitee.com/playa0/cyrene-plugins) 维护，岁月涟漪 v0.6.0 已收录。详见 [issue #13](https://github.com/modusensus/Ripples-of-Aion/issues/13)，上游恢复后本备注即撤下。
...
> **Temporary note (2026-09)**: the Cyrene maintainer's GitHub account is temporarily suspended (appeal in progress), so the upstream repository [`Playa-0v0/Cyrene-Plugins`](https://github.com/Playa-0v0/Cyrene-Plugins) is unreachable for now; plugin inclusion and distribution are temporarily maintained via the [Gitee mirror](https://gitee.com/playa0/cyrene-plugins), where Ripples of Aion v0.6.0 is already listed. See [issue #13](https://github.com/modusensus/Ripples-of-Aion/issues/13) — this note will be removed once the upstream recovers.
